...
Repository writers are serialized. Read-only exploration, review, and independent artifacts outside the repository may fan out in bounded waves. Opening a pull request or merge request is an explicit later workflow, never an automatic final step.
