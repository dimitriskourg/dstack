...
- **Source control history**: {file paths}, {number of commits reviewed}, request IDs, forge CLI when available, and code comments searched. Local Git should always be searched; unavailable forge discussion is reported as a gap.
