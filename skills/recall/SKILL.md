...
Use the active host's configured `transcripts_directory`. Do not search for the directory again. When it is `null` or the directory is unreadable, say so up front and build the brief from steps 4 and 5 alone.
