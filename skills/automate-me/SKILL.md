...
Mining misses intent that hasn't come up yet. Use a structured multi-choice question rather than asking the user to type from scratch.
...
Call the Skill tool with `unslop`. Apply it and the authoring skill's writing guidelines to every line.
